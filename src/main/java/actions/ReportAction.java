...
public class ReportAction extends ActionBase {
    ...
    public void update() throws ServletException, IOException {
        ...
        if (checkToken()) {
            ...
            rv.setFinishTime(getRequestParam(AttributeConst.REP_FINISHTIME));
...
//        if (checkToken()) {
            ...
            //承認情報を設定する
            rv.setApprovalField("承認" + "（" + ev.getName() + "）");
...
//        }
     ...
     * @throws IOException
     */
    public void approveCancel() throws ServletException, IOException{

      //idを条件に日報データを取得する
        ReportView rv = service.findOne(toNumber(getRequestParam(AttributeConst.REP_ID)));

        //承認情報を設定する
        rv.setApprovalField(null);
        ...
        if (errors.size() > 0) {
           ...
           //セッションに更新完了のフラッシュメッセージを設定
        putSessionScope(AttributeConst.FLUSH, MessageConst.I_APPROVEDCANCEL.getMessage());
